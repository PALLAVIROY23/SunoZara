...
class BottomWidget extends StatefulWidget {
  int sid;
  String mode;
  BottomWidget(this.sid, {this.mode = "dark", super.key});
  ...
  void _onItemTapped(int index) {
    ...
    Navigator.pushAndRemoveUntil(
        ...
        PageTransition(
            ...
            child: DashboardTabScreen(index)),
        (route) => false);
    // }
  }
                                                                ...
                                                                child:
                                                                  ...
                                                                  onPressed:
                                                                    ...
                                                                    if (mp.playerd
                                                                      ...
                                                                      Fluttertoast
                                                                          .showToast(
                                                                              msg: "Audio is in loop mode. Can not go back.");
                                                                    } else {
                                                                      pervId();
                                                                      mp.playerd
                                                                          .seekToPrevious();
                                                          ...
                                                          child: IconButton(
                                                            ...
                                                            onPressed: () {
                                                              if (mp.playerd
                                                                ...
                                                                mp.playerd
                                                                    .play();
                                                                context.read<MiniPlayerProvider>().closePlayer(
                                                                    nplayer: mp
                                                                        .playerd,
                                                                    playing:
                                                                        true,
                                                                ...
                                                                child:
                                                                  ...
                                                                  onPressed:
                                                                    ...
                                                                    if (mp.playerd
                                                                      ...
                                                                      Fluttertoast
                                                                          .showToast(
                                                                              msg: "Audio is in loop mode. Can not go to next.");
                                                                    } else {
                                                                      nextId();
                                                                      mp.playerd
                                                                          .seekToNext();
