...
class ProductCardHorizontalWidget extends StatefulWidget {
  dynamic product;
  ProductCardHorizontalWidget(this.product, {super.key});

  @override
  State<ProductCardHorizontalWidget> createState() =>
      _ProductCardHorizontalWidgetState();
}

class _ProductCardHorizontalWidgetState
    extends State<ProductCardHorizontalWidget> {
