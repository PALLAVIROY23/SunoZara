...
class AAudioCardHorizontalWidget extends StatefulWidget {
  dynamic audio;
  String type;
  AAudioCardHorizontalWidget(this.audio, this.type, {super.key});

  @override
  State<AAudioCardHorizontalWidget> createState() =>
      _AAudioCardHorizontalWidgetState();
}

class _AAudioCardHorizontalWidgetState
    extends State<AAudioCardHorizontalWidget> {
  @override
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          "${widget.audio['ratings'].toString()} (${widget.audio['duration'].toString()} min)",
                          style: GoogleFonts.poppins(
